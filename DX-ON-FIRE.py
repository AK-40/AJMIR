...
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗                           ___   _   _ _____ _____ _   _ 
               ...
               AAA                      JJJJJJJJJJJMMMMMMMM               MMMMMMMMIIIIIIIIIIRRRRRRRRRRRRRRRRR        
              A:::A                     J:::::::::JM:::::::M             M:::::::MI::::::::IR::::::::::::::::R       
             A:::::A                    J:::::::::JM::::::::M           M::::::::MI::::::::IR::::::RRRRRR:::::R      
            A:::::::A                   JJ:::::::JJM:::::::::M         M:::::::::MII::::::IIRR:::::R     R:::::R     
           A:::::::::A                    J:::::J  M::::::::::M       M::::::::::M  I::::I    R::::R     R:::::R     
          A:::::A:::::A                   J:::::J  M:::::::::::M     M:::::::::::M  I::::I    R::::R     R:::::R     
         A:::::A A:::::A                  J:::::J  M:::::::M::::M   M::::M:::::::M  I::::I    R::::RRRRRR:::::R      
        A:::::A   A:::::A                 J:::::j  M::::::M M::::M M::::M M::::::M  I::::I    R:::::::::::::RR       
       A:::::A     A:::::A                J:::::J  M::::::M  M::::M::::M  M::::::M  I::::I    R::::RRRRRR:::::R      
      A:::::AAAAAAAAA:::::A   JJJJJJJ     J:::::J  M::::::M   M:::::::M   M::::::M  I::::I    R::::R     R:::::R     
     A:::::::::::::::::::::A  J:::::J     J:::::J  M::::::M    M:::::M    M::::::M  I::::I    R::::R     R:::::R     
    A:::::AAAAAAAAAAAAA:::::A J::::::J   J::::::J  M::::::M     MMMMM     M::::::M  I::::I    R::::R     R:::::R     
   A:::::A             A:::::AJ:::::::JJJ:::::::J  M::::::M               M::::::MII::::::IIRR:::::R     R:::::R     
  A:::::A               A:::::AJJ:::::::::::::JJ   M::::::M               M::::::MI::::::::IR::::::R     R:::::R     
 A:::::A                 A:::::A JJ:::::::::JJ     M::::::M               M::::::MI::::::::IR::::::R     R:::::R     
AAAAAAA                   AAAAAAA  JJJJJJJJJ       MMMMMMMM               MMMMMMMMIIIIIIIIIIRRRRRRRR     RRRRRRR     
...
def sykology():
    ...
    print(" \033[38;5;46m=============================")
    print(" \033[38;5;46m[DX] Update  M")
    print(" \033[38;5;46m[DX] Update Mbasic")
    print(" \033[38;5;46m[DX] Update Free")
    print(" \033[38;5;46m[DX] Update P")
    print(" \033[38;5;46m[DX] Update  X")
    print(" \033[38;5;46m[DX] Update Touch") 
    print(" \033[38;5;46m=============================")
    line()
    ...
    if gxd in ["DX1","M"]:
        fb="m"
        fb1="M1"
    elif gxd in ["DX2","Mbasic"]:
        fb="mbasic"
        fb1="M2"
    elif gxd in ["DX3","Free"]:
        fb="free"
        fb1="M3"
    elif gxd in ["DX4","P"]:
        fb="p"
...
def random_subb(uid,pwx,fb,fb1):
    ...
    sys.stdout.write(f"\r\033[38;5;46m[DX Ajmir] [{fb1}] {loop}|{str(len(oks))}|0");sys.stdout.flush()
...
def approval():
	...
	key = "9".join(uuid)
	a=requests.get("https://github.com/AK-40/Random-cloning-yt/blob/main/Random-cloning.txt").text
	if key in a:
		sykology()
	else:
